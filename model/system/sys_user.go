...
type SysUser struct {
	...
	Password         string            `json:"-"  gorm:"size:256;comment:用户登录密码"`
	...
	SysAuthorityBtns []SysAuthorityBtn `json:"SysAuthorityBtns" gorm:"foreignKey:Authority;references:Authority"`
}
